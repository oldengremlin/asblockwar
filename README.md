...
```
target/ASBlockWar-3.9.1-<buildNumber>.jar
```

Запуск потребує встановленої JRE 25+ на цільовій машині:

```bash
java -jar target/ASBlockWar-3.9.1-00000001.jar [параметри]
```
...
```bash
java -jar ASBlockWar-3.9.1-00000001.jar --config=/etc/asblockwar/asblockwar.properties
```
...
java -jar ASBlockWar-3.9.1-00000001.jar --dependency-graph

# Задати власний шлях
java -jar ASBlockWar-3.9.1-00000001.jar -dg /tmp/asblockwar-graph.html
```
